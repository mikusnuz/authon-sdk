...
class _AsyncUsersAPI:
    ...
    def __init__(self, client: "AsyncAuthonBackend") -> None:
        self._client = client
    ...
    async def get(self, user_id: str) -> AuthonUser:
    ...
    async def update(self, user_id: str, **kwargs: Any) -> AuthonUser:
        body: Dict[str, Any] = {}
        if "email" in kwargs:
    ...
    async def ban(self, user_id: str, reason: Optional[str] = None) -> AuthonUser:
        body: Dict[str, Any] = {}
    ...
    async def unban(self, user_id: str) -> AuthonUser:
...
class AsyncAuthonBackend:
    """
    Asynchronous Authon backend client.

    Usage:
        from authon import AsyncAuthonBackend

        async with AsyncAuthonBackend("sk_live_...") as authon:
    ...
    async def verify_token(self, access_token: str) -> AuthonUser:
    ...
    async def __aenter__(self) -> "AsyncAuthonBackend":
        return self
