...
import { SignedIn, SignedOut, Protect, useUser } from '@authon/nextjs'
    ...
    <div className="page">
      <div style={{ textAlign: 'center', padding: '60px 0 48px' }}>
        ...
        <p style={{
          ...
          Complete authentication flow demo using <code style={{ color: 'var(--accent)', background: 'var(--accent-light)', padding: '2px 8px', borderRadius: 5, fontSize: 15 }}>@authon/nextjs</code>.
        ...
        <SignedIn>
          ...
          <br />
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/profile" className="btn btn-primary" style={{ fontSize: 15, padding: '12px 28px', borderRadius: 10 }}>
              View Profile
            </Link>
            <Link href="/mfa" className="btn btn-secondary" style={{ fontSize: 15, padding: '12px 28px', borderRadius: 10 }}>
              MFA Setup
            </Link>
            <Link href="/sessions" className="btn btn-secondary" style={{ fontSize: 15, padding: '12px 28px', borderRadius: 10 }}>
              Sessions
            </Link>
          </div>
        </SignedIn>
...
{`import { AuthonProvider, SignIn, useAuthon } from '@authon/nextjs'
