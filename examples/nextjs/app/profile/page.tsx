...
import { useUser, useAuthon, UserProfile } from '@authon/nextjs'
      ...
      <div>
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <Link href="/mfa" className="btn btn-secondary" style={{ justifyContent: 'flex-start', gap: 10 }}>
              <span>🔑</span>
              <span>Two-Factor Authentication</span>
            </Link>
            <Link href="/sessions" className="btn btn-secondary" style={{ justifyContent: 'flex-start', gap: 10 }}>
              <span>📱</span>
              <span>Active Sessions</span>
            </Link>
            <Link href="/delete-account" className="btn btn-danger" style={{ justifyContent: 'flex-start', gap: 10 }}>
              <span>⚠️</span>
