...
export function generateNextjsPages(options: ProjectOptions): FileEntry[] {
...
`,
  ...
  files.push({
    ...
    content: `import { SignedIn, SignedOut, UserButton, useAuthon } from '@authon/nextjs';
...
`,
  ...
  files.push({
    ...
    content: `import { useUser, UserButton } from '@authon/nextjs';
import Link from 'next/link';
...
`,
  ...
  files.push({
    ...
    content: `import { useAuthon } from '@authon/nextjs';
...
`,
  ...
  // CLAUDE.md
  files.push({ path: 'CLAUDE.md', content: generateClaudeMd('nextjs-pages') });
