...
- No Angular runtime API changes. This release keeps the fixed Authon SDK version group synchronized.
...
- Align public exports, package metadata, and consumer compatibility with the synchronized Authon SDK release.
